...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001987248736,-1001801289295').split()]
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://gplinks.in')
